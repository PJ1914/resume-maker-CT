    ...
    return (
        <>
            ...
            >
                ...
                <div className="space-y-1 divide-y divide-secondary-100 dark:divide-secondary-700">
                    <button className="w-full flex items-center justify-between p-3 hover:bg-secondary-50 dark:hover:bg-secondary-700/50 rounded-lg transition-colors group">
                        <div className="flex items-center gap-3">
                            <Shield className="h-5 w-5 text-secondary-500 group-hover:text-blue-500 transition-colors" />
                            <div className="text-left">
                                <div className="text-sm sm:text-base font-medium text-secondary-900 dark:text-white">Account Security</div>
                                <div className="text-[10px] sm:text-xs text-secondary-500 dark:text-secondary-400">Password, 2FA, Connected Accounts</div>
                            </div>
                        </div>
                    </button>
                    ...
                    <button className="w-full flex items-center justify-between p-3 hover:bg-secondary-50 dark:hover:bg-secondary-700/50 rounded-lg transition-colors group">
                        <div className="flex items-center gap-3">
                            <Bell className="h-5 w-5 text-secondary-500 group-hover:text-yellow-500 transition-colors" />
                            <div className="text-left">
                                <div className="text-sm sm:text-base font-medium text-secondary-900 dark:text-white">Notifications</div>
                                <div className="text-[10px] sm:text-xs text-secondary-500 dark:text-secondary-400">Email alerts, App updates</div>
                            </div>
                        </div>
                    </button>
                    ...
                    <button
                        onClick={toggleTheme}
                        className="w-full flex items-center justify-between p-3 hover:bg-secondary-50 dark:hover:bg-secondary-700/50 rounded-lg transition-colors group"
                    >
                        <div className="flex items-center gap-3">
                            <Moon className="h-5 w-5 text-secondary-500 group-hover:text-purple-500 transition-colors" />
                            <div className="text-left">
                                <div className="text-sm sm:text-base font-medium text-secondary-900 dark:text-white">App Preferences</div>
                                <div className="text-[10px] sm:text-xs text-secondary-500 dark:text-secondary-400">Toggle Dark/Light Mode</div>
                            </div>
                        </div>
                    </button>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <LogOut className="h-5 w-5 text-secondary-500 group-hover:text-secondary-900 dark:group-hover:text-white transition-colors" />
                            <div className="text-left">
                ...
                <div className="mt-8 pt-6 border-t border-secondary-100 dark:border-secondary-700">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-between p-3 bg-red-50 dark:bg-red-900/10 hover:bg-red-100 dark:hover:bg-red-900/20 rounded-lg transition-colors group border border-red-100 dark:border-red-900/30"
                    >
                        <div className="flex items-center gap-3">
                            <Trash2 className="h-5 w-5 text-red-500 group-hover:text-red-600 transition-colors" />
                            <div className="text-left">
                                <div className="text-sm sm:text-base font-medium text-red-600 dark:text-red-400 group-hover:text-red-700 dark:group-hover:text-red-300">Delete Account</div>
                                <div className="text-[10px] sm:text-xs text-red-400 dark:text-red-500/70">Permanently delete your account and all data</div>
                            </div>
                        </div>
                    </button>
                </div>
