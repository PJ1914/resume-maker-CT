...
export default function EducationStepForm({ data, onChange }: EducationStepFormProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-secondary-900 mb-2">Education</h2>
      ...
      {data.length === 0 ? (
        <div className="bg-secondary-50 border-2 border-dashed border-secondary-300 rounded-lg p-12 text-center">
          ...
          <p className="text-secondary-600 mb-4">No education added yet</p>
          ...
          {data.map((education, index) => (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-secondary-900">Education #{index + 1}</h3>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-secondary-700 mb-2">
                    School / University <span className="text-danger-600">*</span>
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-secondary-700 mb-2">
                    Degree <span className="text-danger-600">*</span>
                  </label>
                  <input
                    type="text"
