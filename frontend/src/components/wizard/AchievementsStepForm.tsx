  ...
  return (
    <div className="space-y-8">
      ...
      <div className="border border-secondary-300 rounded-lg p-6 bg-secondary-50">
        <h3 className="text-lg font-semibold text-secondary-900 mb-4">Add Achievement</h3>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2.5 border border-secondary-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none"
            />
          </div>
      ...
      {safeData.length > 0 && (
        <div className="space-y-3">
          <h3 className="text-lg font-semibold text-secondary-900">Your Achievements</h3>
              ...
              <div className="flex justify-between items-start gap-4">
                <div className="flex-1">
                  ...
                  {achievement.description && (
                    <p className="text-sm text-secondary-600 mt-1">{achievement.description}</p>
                  )}
                  {achievement.date && (
      ...
      {safeData.length === 0 && (
        <div className="bg-secondary-50 border border-secondary-200 rounded-lg p-6 text-center">
          ...
          <p className="text-secondary-600">No achievements added yet</p>
        </div>
      )}
    </div>
  )
