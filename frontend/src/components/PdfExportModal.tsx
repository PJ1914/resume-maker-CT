      ...
      <Dialog as="div" className="relative z-50" onClose={handleClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-6xl transform overflow-hidden rounded-2xl bg-white dark:bg-secondary-900 p-6 text-left align-middle shadow-xl transition-all max-h-[90vh] flex flex-col">
                {/* Header */}
                ...
                {/* Preview Section */}
                <div className="flex-1 overflow-hidden mb-6 border border-secondary-300 dark:border-secondary-700 rounded-lg bg-white dark:bg-secondary-800">
                  <div className="flex flex-col h-full">
                    <div className="px-4 py-3 border-b border-secondary-300 dark:border-secondary-700 flex items-center justify-between">
                      <h4 className="text-sm font-medium text-secondary-700 dark:text-secondary-200">Preview</h4>
                      {previewLoading && (
                    ...
                    <div className="flex-1 overflow-auto flex items-center justify-center bg-gray-50 dark:bg-secondary-900">
                      <Document
                        file={`${API_URL}/api/resumes/${resumeId}/preview/${template}`}
