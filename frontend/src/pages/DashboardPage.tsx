      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        {!loading && (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-10">
            <div className="bg-white dark:bg-secondary-800 rounded-2xl p-4 sm:p-6 shadow-sm border border-secondary-100 dark:border-secondary-700 transition-transform hover:scale-[1.02]">
            ...
            <div className="bg-white dark:bg-secondary-800 rounded-2xl p-4 sm:p-6 shadow-sm border border-secondary-100 dark:border-secondary-700 transition-transform hover:scale-[1.02] sm:col-span-2 md:col-span-1">
              <div className="flex items-center gap-4 mb-2 sm:mb-3">
        ...
        {/* Features */}
        <div className="bg-white dark:bg-secondary-900 border border-secondary-100 dark:border-secondary-800 rounded-2xl p-5 sm:p-8 shadow-sm">
