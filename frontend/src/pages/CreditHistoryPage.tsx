      ...
      <div className="min-h-screen bg-gray-50 dark:bg-secondary-950 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="animate-pulse space-y-4">
            <div className="h-8 bg-gray-300 dark:bg-secondary-800 rounded w-48"></div>
            <div className="space-y-3 mt-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-white dark:bg-secondary-900 rounded-lg p-4 space-y-3">
                  <div className="h-4 bg-gray-200 dark:bg-secondary-800 rounded w-3/4"></div>
                  <div className="h-4 bg-gray-200 dark:bg-secondary-800 rounded w-1/2"></div>
                </div>
              ))}
            </div>
          </div>
