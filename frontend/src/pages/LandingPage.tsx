...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-medium text-white/90">AI Resume Wizard • ATS Analysis • LaTeX PDFs</span>
              </motion.div>
              ...
              <motion.h1
                ...
                className="text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 leading-[0.95] tracking-tighter"
              >
                Build ATS-Perfect
                <br />
                <span className="relative inline-block">
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-2 left-0 right-0 h-3 bg-white/20 -z-0"
                  />
                </span>
                <br />
                with AI
              ...
              <motion.p
                ...
                className="text-xl text-white/60 mb-8 leading-relaxed max-w-xl font-light"
              >
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => navigate('/login')}
                  className="group relative px-8 py-4 bg-white text-black rounded-lg font-bold overflow-hidden"
                >
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 border border-white/20 rounded-lg font-semibold hover:bg-white/5 transition-colors backdrop-blur-xl"
                >
                  Watch Demo
                </motion.button>
              </motion.div>
      ...
      {/* Stats Section */}
      <section className="py-20 px-6 relative border-y border-white/10">
      ...
      <section className="py-20 px-6 relative">
        <div className="container mx-auto max-w-7xl">
          ...
          >
            <h3 className="text-sm font-semibold text-white/40 tracking-widest uppercase mb-8">
      ...
      <section className="py-32 px-6 relative border-y border-white/10">
        <div className="container mx-auto max-w-7xl">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: '-100px' }}
            className="relative bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10 overflow-x-auto"
          >
            <div className="min-w-full">
              ...
              <div className="flex items-start gap-2">
                {[
                  ...
                  >
                    <div className="text-xs font-medium text-white/50 text-center whitespace-pre-line leading-tight">
                      {item.label}
                    </div>
                  </motion.div>
                ))}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-3xl font-bold mb-3">Upload Existing Resume</h3>
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-3xl font-bold mb-3">Professional Templates</h3>
                <p className="text-white/60 mb-6 leading-relaxed">
      ...
      <section className="py-32 px-6 relative">
        <div className="container mx-auto max-w-5xl">
          <motion.div
            ...
            viewport={{ once: true, margin: '-100px' }}
            className="relative bg-white/5 backdrop-blur-2xl rounded-3xl p-16 text-center border border-white/10 overflow-hidden"
          >
      ...
      {/* Footer */}
      <footer className="relative z-10 w-full py-16 px-6 border-t border-white/10 bg-black">
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/templates" className="text-white/60 hover:text-white text-sm block transition">Templates</Link></li>
                <li><Link to="/resumes" className="text-white/60 hover:text-white text-sm block transition">My Resumes</Link></li>
                <li><Link to="/templates" className="text-white/60 hover:text-white text-sm block transition">ATS Checker</Link></li>
                <li><Link to="/pricing" className="text-white/60 hover:text-white text-sm block transition">Pricing</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/features" className="text-white/60 hover:text-white text-sm block transition">Resume Guide</Link></li>
                <li><Link to="/features" className="text-white/60 hover:text-white text-sm block transition">Cover Letter Tips</Link></li>
                <li><Link to="/about" className="text-white/60 hover:text-white text-sm block transition">Career Blog</Link></li>
                <li><Link to="/contact" className="text-white/60 hover:text-white text-sm block transition">Help Center</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/about" className="text-white/60 hover:text-white text-sm block transition">About Us</Link></li>
