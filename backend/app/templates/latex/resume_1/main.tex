...
\BLOCK{ for proj in projects }
    ...
    {\small\textit{\VAR{proj.technologies|join(', ')|escape_tex}}}\BLOCK{ if proj.link } \textbar{} \href{https://\VAR{proj.link|replace('https://', '')|replace('http://', '')}}{\small\faLink\ Link}\BLOCK{ endif }
    \BLOCK{ endif }
