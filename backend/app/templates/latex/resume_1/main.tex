...
\begin{center}
    ...
    \small{
        \BLOCK{ if phone }
        \faPhone\ \VAR{phone}\BLOCK{ if email or linkedin or github } \textbar{}\BLOCK{ endif }
        \BLOCK{ endif }
        \BLOCK{ if email }
        \faEnvelope\ \href{mailto:\VAR{email}}{\VAR{email}}\BLOCK{ if linkedin or github } \textbar{}\BLOCK{ endif }
        \BLOCK{ endif }
        \BLOCK{ if linkedin }
