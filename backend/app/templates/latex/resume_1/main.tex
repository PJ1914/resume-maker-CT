...
\BLOCK{ for exp in experience }
  \resumeSubheading
    ...
    {\VAR{exp.position|escape_tex}}{\VAR{exp.start_date|escape_tex} -- \VAR{exp.end_date|escape_tex}}
...
\BLOCK{ for proj in projects }
    \resumeProject
        ...
        {\VAR{proj.start_date|escape_tex} \BLOCK{ if proj.end_date } -- \VAR{proj.end_date|escape_tex} \BLOCK{ endif }}
        \resumeItemListStart
...
\BLOCK{ for edu in education }
    \resumeSubheading
        ...
        {\VAR{edu.degree|escape_tex} in \VAR{edu.field|escape_tex} \BLOCK{ if edu.gpa }, GPA: \VAR{edu.gpa|escape_tex}\BLOCK{ endif }}{\VAR{edu.start_date|escape_tex} -- \VAR{edu.end_date|escape_tex}}
\BLOCK{ endfor }
\resumeSubHeadingListEnd
\BLOCK{ endif }
