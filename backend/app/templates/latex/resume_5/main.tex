...
\cvtag{\VAR{skill.category}: \VAR{skill.items|join(', ')}}
\BLOCK{ endfor }
\divider
\BLOCK{ endif }
...
\cvevent{\VAR{cert.name}}{\VAR{cert.issuer}}{\VAR{cert.date}}{}
\divider
\BLOCK{ endfor }
\BLOCK{ endif }
...
\cvtag{\VAR{lang.language} (\VAR{lang.proficiency})}
\BLOCK{ endfor }
\divider
\BLOCK{ endif }
...
\item \textbf{\VAR{ach.title}} (\VAR{ach.date})
\BLOCK{ endfor }
\end{itemize}
\BLOCK{ endif }
...
\cvevent{\VAR{exp.position}}{\VAR{exp.company}}{\VAR{exp.start_date} -- \VAR{exp.end_date}}{\VAR{exp.location}}
\begin{itemize}
...
\cvevent{\VAR{edu.degree} in \VAR{edu.field}}{\VAR{edu.institution}}{\VAR{edu.start_date} -- \VAR{edu.end_date}}{\VAR{edu.location}}
\BLOCK{ if edu.gpa }
GPA: \VAR{edu.gpa}
\BLOCK{ endif }
\divider
...
\cvevent{\VAR{proj.name}}{Technologies: \VAR{proj.technologies|join(', ')}}{}{}
\begin{itemize}
